...
package com.google.gwt.site.demo.gwtchosen.widget;
...
public class EventsLogWidget implements IsWidget {
    ...
    private static final class MyEventHandlers implements ChosenChangeHandler, HidingDropDownHandler,
        ...
        private void log(String eventName, String additional) {
            $("#log").append(
                    "<span>" + eventName + " fired by <em>" + elementId + "</em> " + additional + "</span>"
    ...
    interface Binder extends UiBinder<Widget, EventsLogWidget> {
    }
